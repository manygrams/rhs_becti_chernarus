...
CTI_CO_FNC_GetNearbyEnemyTown = compileFinal preprocessFileLineNumbers "Common\Functions\Common_GetNearbyEnemyTown.sqf";
CTI_CO_FNC_GetClosestEntity = compileFinal preprocessFileLineNumbers "Common\Functions\Common_GetClosestEntity.sqf";
CTI_CO_FNC_GetNearbyEntity = compileFinal preprocessFileLineNumbers "Common\Functions\Common_GetNearbyEntity.sqf";
